...
from bannlabtools.devices.instrument import instrument
import numpy as np
import pandas as pd
import time
...
class basesource(instrument, abc.ABC):
...
##### METHODS THAT CAN GENERALLY BE USED ON ALL SOURCES.  REIMPLEMENT IF NECESSARY #######
